...
INDUSTRIES = {
    "logistics": {
        "count": 12,
        "revenue_range": (800_000, 14_000_000),
        "gross_margin": (0.18, 0.32),
        "ebitda_margin": (0.06, 0.14),
        "asset_mult": (1.6, 2.4),
        "debt_ratio": (0.40, 0.60),
        "naics": "484110",
        "purposes": ["working_capital", "equipment_financing", "expansion"],
    },
    "manufacturing": {
        "count": 10,
        "revenue_range": (1_200_000, 22_000_000),
        "gross_margin": (0.22, 0.40),
        "ebitda_margin": (0.08, 0.18),
        "asset_mult": (2.0, 3.2),
        "debt_ratio": (0.45, 0.65),
        "naics": "332710",
        "purposes": ["equipment_financing", "working_capital", "expansion"],
    },
    "technology": {
        "count": 10,
        "revenue_range": (500_000, 9_000_000),
        "gross_margin": (0.55, 0.80),
        "ebitda_margin": (0.10, 0.28),
        "asset_mult": (1.1, 1.8),
        "debt_ratio": (0.20, 0.40),
        "naics": "541511",
        "purposes": ["working_capital", "expansion", "acquisition"],
    },
    "healthcare": {
        "count": 9,
        "revenue_range": (700_000, 18_000_000),
        "gross_margin": (0.30, 0.55),
        "ebitda_margin": (0.08, 0.20),
        "asset_mult": (1.5, 2.8),
        "debt_ratio": (0.35, 0.55),
        "naics": "621111",
        "purposes": ["equipment_financing", "expansion", "real_estate"],
    },
    "retail": {
        "count": 9,
        "revenue_range": (600_000, 11_000_000),
        "gross_margin": (0.25, 0.45),
        "ebitda_margin": (0.05, 0.12),
        "asset_mult": (1.2, 1.9),
        "debt_ratio": (0.50, 0.70),
        "naics": "441110",
        "purposes": ["working_capital", "expansion", "refinancing"],
    },
    "professional_services": {
        "count": 9,
        "revenue_range": (400_000, 7_000_000),
        "gross_margin": (0.50, 0.75),
        "ebitda_margin": (0.12, 0.30),
        "asset_mult": (0.9, 1.5),
        "debt_ratio": (0.20, 0.38),
        "naics": "541200",
        "purposes": ["working_capital", "acquisition", "expansion"],
    },
    "construction": {
        "count": 9,
        "revenue_range": (1_000_000, 20_000_000),
        "gross_margin": (0.15, 0.28),
        "ebitda_margin": (0.05, 0.12),
        "asset_mult": (1.7, 2.8),
        "debt_ratio": (0.50, 0.72),
        "naics": "236220",
        "purposes": ["equipment_financing", "working_capital", "bridge"],
    },
    "other": {
        "count": 12,
        "revenue_range": (500_000, 8_000_000),
        "gross_margin": (0.20, 0.50),
        "ebitda_margin": (0.06, 0.18),
        "asset_mult": (1.2, 2.0),
        "debt_ratio": (0.30, 0.55),
        "naics": "519130",
        "purposes": ["working_capital", "expansion"],
    },
}
...
def generate_gaap_financials(industry: str, trajectory: str, base_revenue: float) -> list[dict]:
    ...
    for i, year in enumerate([2022, 2023, 2024]):
        ...
        results.append(
            {
                "fiscal_year": year,
                "total_revenue": _r2(rev),
                "gross_profit": _r2(gross_profit),
                "operating_expenses": _r2(opex),
                "operating_income": _r2(op_inc),
                "ebitda": _r2(ebitda),
                "depreciation_amortization": _r2(da),
                "interest_expense": _r2(int_exp),
                "income_before_tax": _r2(ebt),
                "tax_expense": _r2(tax),
                "net_income": _r2(net_inc),
                "total_assets": _r2(total_assets),
                "current_assets": _r2(cur_assets),
                "cash_and_equivalents": _r2(cash),
                "accounts_receivable": _r2(ar),
                "inventory": _r2(inv),
                "total_liabilities": _r2(total_liab),
                "current_liabilities": _r2(cur_liab),
                "long_term_debt": _r2(ltd),
                "total_equity": _r2(equity),
                "operating_cash_flow": _r2(op_cf),
                "investing_cash_flow": _r2(inv_cf),
                "financing_cash_flow": _r2(fin_cf),
                "free_cash_flow": _r2(op_cf + inv_cf),
    ...
    for i in range(n):
        ...
        if random.random() < 0.10:
            ...
            flags.append(
                {
                    "flag_type": ft,
                    "severity": "HIGH" if ft == "SANCTIONS_REVIEW" else "MEDIUM",
        ...
        companies.append(
            GeneratedCompany(
                ...
                address_state=jurisdiction,
                relationship_start=fake.date_between(
                    start_date=f"-{min(2024 - founded_year, 10)}y", end_date="-6m"
                ).isoformat(),
                ...
                submission_channel=random.choice(
                    ["web", "web", "web", "mobile", "agent", "branch"]
                ),
